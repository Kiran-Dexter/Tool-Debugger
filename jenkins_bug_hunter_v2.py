...
# Force stdout to UTF-8 encoding to prevent Windows terminal issues
sys.stdout = io.TextIOWrapper(sys.stdout.detach(), encoding='utf-8', errors='replace')

# Expanded shutdown-related keywords
KEYWORDS = [
    "System.exit",
...
CSV_FILENAME = "jenkins_shutdown_report.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Scan Jenkins support bundle for shutdown-related code or logs.")
    ...
    print(f"[INFO] Scanning for shutdown-related keywords in: {scan_path}")
